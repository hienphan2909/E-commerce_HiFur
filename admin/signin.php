        ...
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h1 class="login-heading text-center mb-2">ĐĂNG NHẬP</h1>
              <h3 class="login-heading text-center mb-4">Chào mừng bạn đến với trang đăng nhập Admin HiFur</h3>
              <form method="post">
                <?php
                if (isset($error)) {
